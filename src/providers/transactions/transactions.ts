...
export class TxsProvider {
    ...
    async getTransactionsPerBlock(blockHash: string) {
        ...
        const url = `http://seed4.smarts.cash:8080/v1/blockchain/block/${blockHash}`;
    ...
    async getTransactionsPerAddress(address: string) {
        const url = `http://seed4.smarts.cash:8080/v1/address/transaction/${address}`;
    ...
    async getTransactionsPerAddressNew(address: string) {
        const url =  `http://seed4.smarts.cash:8080/v1/address/transactions`;
        let txs: ApiTx[] = [];
    ...
    public getTxs(chainNetwork: ChainNetwork, args?: { blockHash?: string }): Observable<ApiUtxoCoinTx[]> {
        ...
        const url = `http://seed4.smarts.cash:8080/v1/tx/${queryString}`;
    ...
    public async getUnmappedTxByAddress(addrStr: string) {
        ...
        const url = `http://seed4.smarts.cash:8080/v1/address/transaction/${addrStr}`;
        return this.httpClient.get<any>(url).toPromise();
    }

    public async getUnmappedTx(hash: string) {

        const url = `http://seed4.smarts.cash:8080/v1/transaction/check/${hash}`;
        return this.httpClient.get<any>(url).toPromise();
    }
