...
var TransactionSummaryEthComponent = /** @class */ (function () {
    ...
    TransactionSummaryEthComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'transaction-summary-eth',template:/*ion-inline-start:"/Volumes/files/git2021/sapi_explorer/src/components/transaction-summary-eth/transaction-summary-eth.html"*/'<ion-item>\n  Gas Limit\n  <ion-note item-end>\n      <span text-nowrap>{{ tx.gasLimit }}</span>\n  </ion-note>\n</ion-item>\n<ion-item>\n  Gas Price\n  <ion-note item-end>\n    <span text-nowrap>{{ currencyProvider.getConvertedNumber(tx.gasPrice, chainNetwork.chain) | number:\'1.0-8\' }}\n        {{ currencyProvider.currencySymbol }}</span>\n  </ion-note>\n</ion-item>\n<ion-item>\n  From\n  <ion-note item-end>\n    {{ tx.from }}\n  </ion-note>\n</ion-item>\n<ion-item>\n  To\n  <ion-note item-end>\n    {{ tx.to }}\n  </ion-note>\n</ion-item>\n<ion-item *ngIf="tx.confirmations > 0">\n  Mined Time\n  <ion-note item-end>\n    {{ tx.blocktime * 1000 | date:\'long\' }}\n  </ion-note>\n</ion-item>'/*ion-inline-end:"/Volumes/files/git2021/sapi_explorer/src/components/transaction-summary-eth/transaction-summary-eth.html"*/
        }),
...
var TransactionSummaryComponent = /** @class */ (function () {
    ...
    TransactionSummaryComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'transaction-summary',template:/*ion-inline-start:"/Volumes/files/git2021/sapi_explorer/src/components/transaction-summary/transaction-summary.html"*/'<ion-item>\n  Size\n  <ion-note item-end>\n    {{ tx.size }} (bytes)\n  </ion-note>\n</ion-item>\n<ion-item *ngIf="tx.fee >= 0">\n  Fee Rate\n  <ion-note item-end>\n    {{ (tx.fee / tx.size) | number:\'1.0-2\' }} sats/byte\n  </ion-note>\n</ion-item>'/*ion-inline-end:"/Volumes/files/git2021/sapi_explorer/src/components/transaction-summary/transaction-summary.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__providers_currency_currency__["a" /* CurrencyProvider */]])
